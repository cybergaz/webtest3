...
if(localStorage.getItem("gaz_ticket")){
    //retrieve and display tickets
    ticketArr = JSON.parse(localStorage.getItem("gaz_ticket"));
...
function createTicket(ticketColor, ticketTask, ticketID) {
    ...
    if(!ticketID) {
        ...
        localStorage.setItem("gaz_ticket",JSON.stringify(ticketArr));
    }
...
function handleRemoval(ticket , id) {
    ticket.addEventListener("click" , (e) =>{
        ...
        localStorage.setItem("gaz_ticket", strTicketArr);
        ticket.remove(); 
    })
}
